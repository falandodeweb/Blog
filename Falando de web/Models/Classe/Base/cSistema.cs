...
{
    public static void InserirErro(string mensagem, string inner)
    {
        try
        {
            if (!mensagem.Contains("favicon") || !mensagem.Contains("robots") || !mensagem.Contains("apple-"))
            {
    ...
    public static bool VerificarSeMobile()
    {
